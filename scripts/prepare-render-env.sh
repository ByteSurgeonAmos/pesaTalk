...
echo "# NOTE: Get these from your Render PostgreSQL service"
echo "DATABASE_URL=<Get from Render PostgreSQL Internal Database URL>"
echo "DATABASE_USERNAME=<Get from Render PostgreSQL>"
echo "DATABASE_PASSWORD=<Get from Render PostgreSQL>"
echo ""
...
echo "2. Get DATABASE_URL, DATABASE_USERNAME, DATABASE_PASSWORD from Render PostgreSQL service"
echo "3. Get REDIS_HOST from Render Redis service"
echo "4. Change SPRING_PROFILES_ACTIVE to 'prod' (not 'dev')"
echo "5. Change SERVER_PORT to '10000' (Render's default port)"
echo ""
